 ...
 * currently being viewed in a {@link ProviderDetailFragment}.
 * <p/>
...
public class ProviderListFragment extends ListFragment {
    ...
    public void onAttach(Activity activity) {
        ...
        mAdapter = new ProviderAdapter(getActivity(), providers);
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        mCallbacks.onProviderSelected(mAdapter.getItem(position).getName());
    }
